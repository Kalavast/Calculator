...
void Menu(){
        ...
        do{
                cout 
                     << "Addition press <1>" << endl
                     << "Multiplication press  <2>" << endl
                     << "Subtraction press  <3>" << endl
                     << "Divison press  <4>" << endl
                     << "Squareroot press  <5>" << endl
                     << "Squared press  <6>" << endl
                     << "Power press  <7>" << endl
                     << "logarithm press  <8>" << endl
                     << "Creat list press <9>" << endl
                     << "Sort list press <10>" << endl
                     << "Find First Varible Statistics <11>" << endl
                     << "Display List <12>" << endl
                        << "Quit press <0>" << endl;
